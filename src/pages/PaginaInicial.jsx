...
const PaginaInicialPage = () => {
  ...
  return (
    <div>
      ...
      <div
        id="video-pitch"
        className="flex flex-col bg justify-center items-center p-8 bg-[#f8faff] font-bold text-secondary-deep mt-4"
      >
        <p className="text-center w-full text-4xl">Video Pitch</p>
        <iframe
          className="w-full max-w-[1200px] h-[675px] mt-8"
          src="https://www.youtube.com/embed/l121kncpVC8?si=LuvHDnuTqu1Qm-Sq"
